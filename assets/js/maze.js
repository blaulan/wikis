...
var INSTRUCTIONS = '<br><br><div style="margin-left: auto; margin-right: auto; text-align: center;"><img src="directions.png" width="200px" style="vertical-align: middle;" title="Movement: Up: W, Down: S, Left: A, Right: D">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="click.png" width="100px" style="vertical-align: middle;" title="Click on maze to jump to previously visited location"></div>';
...
function LoadMaze()
{
    ...
    // show the links
    // document.getElementById('links').innerHTML = '<button type="button" onclick="PlayPuzzle()">Play!</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" onclick="ShowPuzzle()">View Printer-Friendly Version</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" onclick="ShowAnswer()">View Answer</button>';
